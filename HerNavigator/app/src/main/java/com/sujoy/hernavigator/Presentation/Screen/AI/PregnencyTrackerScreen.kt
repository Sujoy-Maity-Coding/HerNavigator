...
fun PregnencyTrackerScreen(
    ...
    val week = remember { mutableStateOf("") }
    val textResult = viewModel.pregnencyTrackerResult.collectAsState().value
        ...
        Column(
            ...
            Image(
                painter = rememberAsyncImagePainter(
                    ImageRequest.Builder(context2).data(data = R.drawable.pregnancy_gif).apply(block = {
                        size(Size.ORIGINAL)
            ...
            Text(
                text = "\"Carrying a baby is the most rewarding experience a woman can enjoy\"",
                fontSize = 20.sp,
            ...
            OutlinedTextField(
                value = week.value, onValueChange = { week.value = it },
                label = { Text(text = "Enter Week", color = Pink) },
                placeholder = { Text(text = "How many weeks pregnant are you?", color = Color.Gray) },
            ...
            Image(painter = painterResource(id = R.drawable.sent), contentDescription = null,
                modifier = Modifier.size(60.dp).clickable {
                    viewModel.pregnencyTrackerGenerator(week.value)

...
fun OccasionScreen(
    ...
    val event = remember { mutableStateOf("") }
    val textResult = viewModel.occasionResult.collectAsState().value
        ...
        Column(
            ...
            Image(
                painter = rememberAsyncImagePainter(
                    ImageRequest.Builder(context2).data(data = R.drawable.fashion_gif).apply(block = {
                        size(Size.ORIGINAL)
            ...
            Text(
                text = "\"Life isn’t perfect but your outfit can be.\"",
                fontSize = 20.sp,
            ...
            OutlinedTextField(
                value = event.value, onValueChange = { event.value = it },
                label = { Text(text = "Enter Event", color = Pink) },
                placeholder = { Text(text = "e.g., Summer Wedding", color = Color.Gray) },
            ...
            Image(painter = painterResource(id = R.drawable.sent), contentDescription = null,
                modifier = Modifier.size(60.dp).clickable {
                    viewModel.occasionOutfitGenerator(event.value)

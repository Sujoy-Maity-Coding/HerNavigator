...
fun WeatherWiseSkin(
    ...
    val skinType = remember { mutableStateOf("") }
    val textResult = viewModel.skinCareResult.collectAsState().value
        ...
        Column(
            ...
            Image(
                painter = rememberAsyncImagePainter(
                    ImageRequest.Builder(context2).data(data = R.drawable.skin_gif).apply(block = {
                        size(Size.ORIGINAL)
            ...
            Text(
                text = "\"Self care starts with skin care.\"",
                fontSize = 20.sp,
            ...
            OutlinedTextField(
                value = skinType.value, onValueChange = { skinType.value = it },
                label = { Text(text = "Enter skinType", color = Pink) },
                placeholder = { Text(text = "e.g., oily skin", color = Color.Gray) },
            ...
            Image(painter = painterResource(id = R.drawable.sent), contentDescription = null,
                modifier = Modifier.size(60.dp).clickable {
                    viewModel.skinCareGenerator(weather = weather.value, skinType = skinType.value)

...
fun PeriodPainScreen(
    ...
    val textResult = viewModel.periodPainResult.collectAsState().value
        ...
        Column(
            ...
            Image(
                painter = rememberAsyncImagePainter(
                    ImageRequest.Builder(context2).data(data = R.drawable.period_gif).apply(block = {
                        size(Size.ORIGINAL)
            ...
            OutlinedTextField(
                value = symptoms.value, onValueChange = { symptoms.value = it },
                label = { Text(text = "Enter Symptoms", color = Pink) },
                placeholder = { Text(text = "e.g., cramps or back pain", color = Color.Gray) },
            ...
            Image(painter = painterResource(id = R.drawable.sent), contentDescription = null,
                modifier = Modifier.size(60.dp).clickable {
                    viewModel.periodPainGenerator(symptoms.value)
